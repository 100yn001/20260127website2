...
function hexToRgb(hex: string): { r: number; g: number; b: number } {
  ...
  return { r: 127, g: 29, b: 29 }; // fallback
}
...
/**
 * TopographicArtwork - Creates a wavy textured gradient using Skia
 * Renders organic, flowing patterns with turbulence noise over a base color
 */
export default function TopographicArtwork({
  ...
  // Use layers to seed randomness for consistent rendering
