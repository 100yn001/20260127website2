/**
 * Narration modes — VERBATIM COPY of constants/narration-modes.ts.
 *
 * KEEP IN SYNC: the app's constants/narration-modes.ts is the source of truth
 * (functions can't import app code across the tsconfig boundary). When tuning
 * textures/wpm there, re-copy the file here. fable_test.mjs mirrors it too.
 *
